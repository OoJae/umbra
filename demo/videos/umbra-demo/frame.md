...
description: >
  ...
  Bodoni Moda in lowercase weight 900 treated as graphic primitive, IBM Plex Mono chrome (uppercase,
...
typography:
  # — reading ramp —
  body:    { fontFamily: "Instrument Sans", cqw: 1.2, weight: 400, lineHeight: 1.6 }
  lead:    { fontFamily: "Instrument Sans", cqw: 1.6, weight: 400, lineHeight: 1.5 }
  caption: { fontFamily: "Instrument Sans", cqw: 0.9, weight: 400, lineHeight: 1.5 }
  label:   { fontFamily: "IBM Plex Mono", cqw: 0.72, weight: 500, tracking: "0.14em", upper: true }
  # — display / hero ramp (Bodoni Moda, lowercase, negative tracking) —
  h3:      { fontFamily: "Bodoni Moda", cqw: 2.8, weight: 400, lineHeight: 1.2 }
  quote-text:{ fontFamily: "Bodoni Moda", cqw: 3.8, weight: 400, lineHeight: 1.15, tracking: "-0.02em" }
  h2:      { fontFamily: "Bodoni Moda", cqw: 4.5, weight: 400, lineHeight: 1.1, tracking: "-0.02em" }
  stat-value:{ fontFamily: "Bodoni Moda", cqw: 5.5, weight: 400, lineHeight: 1.0, tracking: "-0.04em" }
  h1:      { fontFamily: "Bodoni Moda", cqw: 7.5, weight: 400, lineHeight: 0.9, tracking: "-0.03em" }
  fadelist-item:{ fontFamily: "Bodoni Moda", cqw: 7.5, weight: 400, lineHeight: 1.0, tracking: "-0.03em" }
  quote-mark:{ fontFamily: "Bodoni Moda", cqw: 10.0, weight: 400, lineHeight: 0.6 }
  fadelist-title:{ fontFamily: "Bodoni Moda", cqw: 10.5, weight: 400, lineHeight: 0.9, tracking: "-0.04em" }
  display: { fontFamily: "Bodoni Moda", cqw: 13.0, weight: 400, lineHeight: 0.88, tracking: "-0.04em" }
...
- **Fonts** — already set to **Bodoni Moda** (display) / **Instrument Sans** (body); ignore any preset font name lingering in prose.
...
text and becomes graphic primitive.** Bodoni Moda `display` at 13cqw puts a single lowercase word
...
**Bodoni Moda** carries every text role from display to body — expressive range from weight (400–900)
...
- **Massive lowercase Bodoni Moda 900**, negative-tracked, as graphic primitive (display 13cqw).
...
Two ramps. The **reading ramp** (Bodoni Moda body 1.2cqw, mono label 0.72cqw) carries copy + chrome; the
**display ramp** (Bodoni Moda `h2` 4.5cqw → `display` 13cqw, weight 700–900) carries every statement.
...
- **Bodoni Moda display is lowercase, weight 700–900, negative-tracked** (−0.04em largest, −0.02em h2). **Mono chrome is uppercase, 0.1em+.** No italic, no underline, no uppercase display.
...
Bodoni Moda `display` (13cqw) lowercase in ink, left-anchored, over a small ink rule stub + mono kicker; a
Bodoni Moda lead line beneath in 75% ink. **Chrome** mono catalogue number top-left, mono meta top-right
...
**Ground** ink-black. **Composes** kicker, display. **Focal** a 2–4 word Bodoni Moda `display`/`h1`
...
row of three top-border-only stat-cards — big Bodoni Moda-900 numeral in `{colors.fire-orange}`, Bodoni Moda
...
**Ground** ink-black. **Composes** fadelist (3 stacked Bodoni Moda-900 words at 1.0/0.5/0.22), fadelist-title.
...
Bodoni Moda `quote-text` (700, lowercase) at ≤78cqw under an oversized fire-orange `quote-mark` (10cqw,
...
- Set every Bodoni Moda display in **lowercase weight 900**, negative-tracked — the system's signature.
...
- Never uppercase Bodoni Moda display; never add a second accent color.
...
- No serif companion; chrome is never Bodoni Moda.
...
- **Type** — Bodoni Moda lowercase 900 negative-tracked, fit-to-measure; mono chrome uppercase 0.14em; ≥1.4cqw floor.
...
- **Bodoni Moda + IBM Plex Mono via Google Fonts**; Noto Sans SC is the CJK fallback (the lowercase-display signal has no CJK equivalent — the two-register color system carries the identity, per the source).
